...
public class ByrdBanePower extends AbstractPower {
    public static PowerType POWER_TYPE = PowerType.BUFF;

    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings("FireBladeMod:ByrdBanePower");
    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;

    private AbstractCreature source;

    public ByrdBanePower(AbstractCreature owner, int amount) {
        this.ID = "FireBladeMod:ByrdBanePower";
        this.owner = owner;
        this.amount = amount;
