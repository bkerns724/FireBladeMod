...
public class FlameStrike extends CustomCard {
    ...
    public static final String ID = "FireBladeMod:FlameStrike";
    public static final String NAME;
    public static final String DESCRIPTION;
    public static final String IMG_PATH = "theFireBladeResources/images/cardImages/FlameStrike.png";
    ...
    public AbstractCard makeCopy() { return new FlameStrike(); }
